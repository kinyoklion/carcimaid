...
fn map_shape(name: &str) -> NodeShape {
    match name {
        ...
        "notch-pent" | "loop-limit" | "notched-pentagon" => NodeShape::NotchedPentagon,
        "tri" | "extract" | "triangle" => NodeShape::Triangle,
        "flip-tri" | "manual-file" | "flipped-triangle" => NodeShape::FlippedTriangle,
        "sl-rect" | "manual-input" | "sloped-rectangle" => NodeShape::SlopedRect,
